...
const results: SearchResult[] = [
  ...
  {type: 'Reparatur', title: 'Audio-Reparatur', detail: 'Player, Receiver und Verstärker', href: '/audio-reparatur', terms: ['audio', 'hifi', 'dvd', 'blu-ray', 'vhs', 'receiver', 'verstärker', 'cd']},
  ...
  {type: 'Reparatur', title: 'Platinen-Reparatur', detail: 'Steuerplatinen, Displays und Anschlüsse', href: '/platinen-reparatur', terms: ['platine', 'platinen', 'display', 'usb', 'buchse', 'elektronik']},
  {type: 'Gerät', title: 'Elektronik-Reparatur', detail: 'Elektronische Baugruppen und Bedienelemente', href: '/elektronik-reparatur', terms: ['elektronik', 'baugruppe', 'schalter', 'taster', 'bedienelement']},
  {type: 'Fehler', title: 'Gerät geht nicht an', detail: 'Diagnose für Strom- und Elektronikfehler', href: '/reparaturen#fehlerbilder', terms: ['geht nicht an', 'defekt', 'strom', 'ausfall', 'funktioniert nicht']},
  ...
  return (
    <div className="search-overlay" role="dialog" aria-modal="true" aria-label="Globale Suche" onMouseDown={event => event.target === event.currentTarget && onClose()}>
      <div className="search-panel">
        ...
        <label className="search-input-wrap"><SearchIcon /><input ref={inputRef} value={query} onChange={event => setQuery(event.target.value)} placeholder="Was möchtest du reparieren?" aria-label="Suchbegriff" /></label>
